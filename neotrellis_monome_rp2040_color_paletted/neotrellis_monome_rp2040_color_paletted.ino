...
const uint8_t allpalettes[25][3][16] = {
  ...
  {//original orange
     {255, 255, 255, 254, 254, 254, 253, 253, 253, 253, 252, 252, 252, 252, 253, 253},
     { 62,  78,  92, 104, 115, 125, 135, 144, 153, 162, 170, 178, 186, 193, 201, 208},
     {  0,   1,   6,  13,  20,  28,  37,  45,  54,  63,  73,  83,  93, 103, 114, 125}
  },
  // {//spectral
